...
This test assignment is not going to be a real project in production. This test assignment is not going to have managers. This this test assignemnt project is not going to change frequently. So I think that creating Currency in a way that it was created makes sense for this project.  
