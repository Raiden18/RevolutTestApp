...
class CurrencyRateUiMapperImpl : CurrencyRateUiMapper {
    ...
    override fun mapToUiCurrency(currency: com.example.revoluttestapp.domain.models.currencies.Currency, flag: com.example.revoluttestapp.domain.models.Flag): UiCurrency {
